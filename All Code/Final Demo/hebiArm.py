...
def setup():
  lookup = hebi.Lookup()
  group = lookup.get_group_from_names(['ShipBotB'], ['Base', 'Shoulder', 'Elbow', 'Wrist'])
  ...
  model.add_link('X5', 0.265, numpy.pi)
  model.add_actuator('X5-4')
...
def generate_waypoints(model, current_pos):
  return [r(-.4, .4), r(0.25, 1.2), r(0.75, 2.0), r(-1.5, 1.5), r(-1.5, 1.5)]
